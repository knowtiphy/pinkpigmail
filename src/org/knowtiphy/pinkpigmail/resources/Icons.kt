...
object Icons
{
    ...
    fun attach(size: Int): Group
    {
        ...
        val g = Fonts.FONT.create(FontAwesome.Glyph.PAPERCLIP).color(ICON_COLOR).size(size.toDouble())
        val grp = Group(g)
        grp.rotate = 90.0
        return grp
    }
    ...
    @JvmStatic
    fun reply(size: Int): Glyph
    {
        return Fonts.FONT.create(FontAwesome.Glyph.MAIL_REPLY).color(ICON_COLOR).size(size.toDouble())
    }

    @JvmStatic
    fun replyAll(size: Int): Glyph
    {
        return Fonts.FONT.create(FontAwesome.Glyph.MAIL_REPLY_ALL).color(ICON_COLOR).size(size.toDouble())
    }

    @JvmStatic
    fun forward(size: Int): Glyph
    {
        return Fonts.FONT.create(FontAwesome.Glyph.MAIL_FORWARD).color(ICON_COLOR).size(size.toDouble())
    }

    @JvmStatic
    fun delete(size: Int): Glyph
    {
        return Fonts.FONT.create(FontAwesome.Glyph.TRASH).color(ICON_COLOR).size(size.toDouble())
    }
    ...
    @JvmStatic
    fun send(size: Int): Glyph
    {
        return Fonts.FONT.create(FontAwesome.Glyph.PAPER_PLANE).color(ICON_COLOR).size(size.toDouble())
    }

    @JvmStatic
    fun trustContentProvider(size: Int): Glyph
    {
        return Fonts.FONT.create(FontAwesome.Glyph.HTML5).color(ICON_COLOR).size(size.toDouble())
    }
    ...
    @JvmStatic
    fun junk(size: Int = Icons.SMALL_SIZE): Glyph = Fonts.FONT.create(FontAwesome.Glyph.CIRCLE).color(Color.ORANGE).size(size.toDouble())

    @JvmStatic
    fun unread(size: Int = Icons.SMALL_SIZE): Glyph = Fonts.FONT.create(FontAwesome.Glyph.CIRCLE).color(Icons.ICON_COLOR).size(size.toDouble())

    @JvmStatic
    fun answered(size: Int = Icons.SMALL_SIZE): Glyph = Fonts.FONT.create(FontAwesome.Glyph.REPLY).color(Icons.ICON_COLOR).size(size.toDouble())
